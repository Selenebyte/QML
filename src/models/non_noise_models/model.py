...
class quantum_model(model_framework):
    def __init__(self, parameter_shape, dev):
        self.dev = dev

        q_node = qml.QNode(self.Quantum_model, self.dev, interface="torch")
    ...
    def Measureable_quantum_model(self, parameters, inputs, dev, degree):
        return super().Measureable_quantum_model(parameters, inputs, dev, degree)
